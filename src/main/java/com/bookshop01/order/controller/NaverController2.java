...
//		resultMap.put("type","NAVER_CARD"); //  NAVER_CARD NAVER_POINT
//		resultMap.put("authDateTime","202305021216");
//		resultMap.put("amount","100");
//		resultMap.put("authNumber","15616414561");
//		resultMap.put("cardName","삼성카드");
//		resultMap.put("cardNo","5136182311158171");
//		resultMap.put("quota","0");
//		resultMap.put("cardCode","CCNH");
//		resultMap.put("binType01","0");
//		resultMap.put("binType02","1");
