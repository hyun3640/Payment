...
function fn_process_pay_order(){
	...
	var expireMomth = document.getElementById("expireMonth").value;
					...
					<table>
						<tbody align=left>
							...
							<tr>
								...
								<td align=left><input type="text" id="cardNo" name="cardNo">
								</td>
							</tr>
							<tr>
								<td width=200px>유효기간 월:</td>
								<td align=left><input type="text" id="expireMonth"
									name="expireMonth"></td>
							<tr>
								<td width=200px>유효기간 년:</td>
								<td align=left><input type="text" id="expireYear"
									name="expireYear"></td>
							<tr>
							...
							<tr>
								...
								<td align=left><input type="text" id="cardPw" name="cardPw">
								</td>
							</tr>
							<tr>
...
if (frm.res_cd.value == "0000") {
            ...
            // 1. 선택된 라디오버튼을 확인 후 승인요청 할 예정
           	// 2. order_info 값 중 kakaopay_direct== 'Y', naverpay_direct== 'Y'
