...
public class NaverController {
    ...
    public Map<String,Object> kakaoOrder(@RequestParam Map<String, String> dateMap) throws Exception{
        ...
        map.put("orderNumber","TEST_123456"); //주문데이터 생성해야지 생기는 키값 (생성을 안해서 임의값)
...
//      {good_mny=100, site_cd=T0000, Ret_URL=naver.com, affiliaterCode=0005, buyr_name=테스트중, ordr_idxx=20230502144510NV0768, good_name=무작정 따라가기 홍콩 마카오, naverpay_point_direct=N, responseCode=0000, responseMsg=성공}
